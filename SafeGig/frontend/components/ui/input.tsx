...
function Input({ className, type, insetFocus = true, ...props }: InputProps) {
  return (
    <input
      type={type}
      data-slot="input"
      className={cn(
        ...
        "focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] focus-visible:shadow-[inset_0_0_0_2px_hsl(var(--primary)) bg-inherit",
